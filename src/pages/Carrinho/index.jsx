...
export const Carrinho = () => {
    ...
    function atulizaTotal(carrinho) {
        var total = 0;
        carrinho.forEach(e => {
            total = total + e.total;
        })
    ...
    return(
        <>
                    ...
                    {produtos ?
                        produtos.map((item,index) => (
                            <tr>
                                ...
                                <td>
                                    <button type="button" className="btn btn-danger" onClick={()=>remover(item.id)}>Exc.</button>
                                </td>
                            </tr>
                        ))
                    :
            ...
            <button type="button" className="btn btn-success float-end" on onClick={()=>finalizar()}>
                Finalizar Compra
            </button>
